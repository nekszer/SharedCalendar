<?php
    ...
    $this->set_css($this->default_theme_path.'/bootstrap-v5/css/add-edit-form.css');
    ...
    if ($this->config->environment == 'production') {
        ...
        $this->set_js_config($this->default_theme_path.'/bootstrap-v5/js/form/edit.min.js');
    } else {
        $this->set_js_lib($this->default_javascript_path . '/' . $jquery_js);
        $this->set_js_lib($this->default_theme_path.'/bootstrap-v5/js/jquery-plugins/jquery.form.min.js');
        $this->set_js_lib($this->default_theme_path.'/bootstrap-v5/js/common/common.min.js');
        $this->set_js_config($this->default_theme_path.'/bootstrap-v5/js/form/edit.js');
    }
            ...
            <div class="col-md-12">
                ...
                <div class="form-container table-container">
                    ...
                    <?php foreach($fields as $field) { ?>
                        <div class="form-group <?php echo $field->field_name; ?>_form_group mb-3 row">
