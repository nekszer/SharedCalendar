<?php
    ...
    if ($this->config->environment == 'production') {
        ...
        $this->set_js_config($this->default_theme_path.'/metronic/js/form/edit.min.js');
    } else {
        $this->set_js_lib($this->default_javascript_path . '/' . $jquery_js);
        ...
        $this->set_js_config($this->default_theme_path.'/metronic/js/form/edit.js');
    }
    ...
    <div class="gc-container">
        <div class="row">
            <div class="col-md-12" style="padding: 0px; padding-right: 5px; padding-left: 5px;">
                <div class="floatL l5">
                    <span class="text-muted mt-1 fw-bold fs-7"><?php echo $this->l('form_edit'); ?> <?php echo $subject?></span>
                </div>
                <div class="clear"></div>
