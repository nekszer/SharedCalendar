...
namespace SharedCalendar.Resources.Strings
{
    public class JsonLocalizationManager : BaseResource, ILocalizationManager
    {
        ...
        private Dictionary<string, Dictionary<string, object>> GetLanguageStrings()
        {
        ...
        private Dictionary<string, Dictionary<string, object>> GetDictionary(string filename)
        {
            ...
            using (var reader = new StreamReader(stream))
            {
                ...
                try
                {
                    dictionary = Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, Dictionary<string, object>>>(json);
                }
                catch { }
            }
            return dictionary;
